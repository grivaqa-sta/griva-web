...
export default function OrdersTab({ ordersList, setOrdersList }: OrdersTabProps) {
  ...
  return (
    <div className="space-y-6 animate-in fade-in-50 duration-300">
      ...
      <div className={`flex flex-wrap items-center justify-between gap-4 p-4.5 rounded-2xl border shadow-xs transition-colors ${
        isDark ? 'bg-zinc-900 border-zinc-800' : 'bg-white border-orange-500/30'
      }`}>
        <div>
          <h3 className={`text-sm font-black uppercase tracking-wider ${isDark ? 'text-zinc-100' : 'text-gray-800'}`}>Order Operations</h3>
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <button
            ...
            className={`flex items-center gap-2 px-4.5 py-2.5 border rounded-xl text-xs font-bold transition-all cursor-pointer flex items-center justify-center ${
              isDark ? 'border-zinc-700 text-zinc-300 hover:bg-zinc-800 hover:text-white' : 'border-orange-500/30 text-gray-700 hover:bg-orange-500/5 hover:text-gray-900'
            }`}
          >
      ...
      <div className={`flex flex-wrap gap-4 items-center p-4 rounded-2xl border shadow-xs transition-colors ${
        isDark ? 'bg-zinc-900 border-zinc-800' : 'bg-white border-orange-500/30'
      }`}>
        ...
        <div className="flex-1 min-w-[250px] relative">
          <input
            ...
            className={`w-full text-xs font-semibold pl-4 pr-10 py-2.5 border rounded-xl outline-none transition-all shadow-xs ${
              isDark ? 'bg-zinc-800 border-zinc-700 text-zinc-100 placeholder-zinc-500 focus:bg-zinc-800' : 'bg-gray-50 border-orange-500/10 text-gray-800 focus:bg-white'
            }`}
          />
          {searchQuery && (
            <button
        ...
        <div className="relative z-[47]">
          <button
            ...
            className={`flex items-center justify-between gap-1.5 px-3 py-2.5 border rounded-xl text-xs font-bold cursor-pointer min-w-[140px] text-left transition-colors ${
              isDark ? 'bg-zinc-800 border-zinc-700 text-zinc-200' : 'bg-gray-50 border-orange-500/10 text-gray-750'
            }`}
          >
            <span>
          ...
          {openDateSelect && (
            <>
              ...
              <div className={`absolute left-0 right-0 top-full mt-1 border rounded-xl shadow-xl z-50 py-1 overflow-hidden animate-in fade-in slide-in-from-top-2 duration-150 min-w-[140px] ${
                isDark ? 'bg-zinc-800 border-zinc-700' : 'bg-white border-gray-100'
              }`}>
                <button
                  type="button"
                  onClick={() => { setFilterDateRange("all"); setOpenDateSelect(false); }}
                  className={`w-full text-left px-3 py-2 text-xs font-semibold ${filterDateRange === "all" ? "text-orange-500 bg-orange-50/50 font-bold" : isDark ? "text-zinc-300 hover:bg-zinc-700/60 hover:text-orange-400" : "text-gray-700 hover:bg-orange-50 hover:text-orange-500"}`}
                >
                  📅 All Time
                </button>
                <button
                  ...
                  className={`w-full text-left px-3 py-2 text-xs font-semibold ${filterDateRange === "today" ? "text-orange-500 bg-orange-50/50 font-bold" : isDark ? "text-zinc-300 hover:bg-zinc-700/60 hover:text-orange-400" : "text-gray-700 hover:bg-orange-50 hover:text-orange-500"}`}
                >
                  📅 Today
                </button>
                <button
                  ...
                  className={`w-full text-left px-3 py-2 text-xs font-semibold ${filterDateRange === "yesterday" ? "text-orange-500 bg-orange-50/50 font-bold" : isDark ? "text-zinc-300 hover:bg-zinc-700/60 hover:text-orange-400" : "text-gray-700 hover:bg-orange-50 hover:text-orange-500"}`}
                >
                  📅 Yesterday
                </button>
                <button
                  ...
                  className={`w-full text-left px-3 py-2 text-xs font-semibold ${filterDateRange === "week" ? "text-orange-500 bg-orange-50/50 font-bold" : isDark ? "text-zinc-300 hover:bg-zinc-700/60 hover:text-orange-400" : "text-gray-700 hover:bg-orange-50 hover:text-orange-500"}`}
                >
                  📅 Last 7 Days
                </button>
              </div>
        ...
        <div className="relative z-[46]">
          <button
            ...
            className={`flex items-center justify-between gap-1.5 px-3 py-2.5 border rounded-xl text-xs font-bold cursor-pointer min-w-[160px] text-left transition-colors ${
              isDark ? 'bg-zinc-800 border-zinc-700 text-zinc-200' : 'bg-gray-50 border-orange-500/10 text-gray-750'
            }`}
          >
            <span>
          ...
          {openPrintSelect && (
            <>
              ...
              <div className={`absolute left-0 right-0 top-full mt-1 border rounded-xl shadow-xl z-50 py-1 overflow-hidden animate-in fade-in slide-in-from-top-2 duration-150 min-w-[160px] ${
                isDark ? 'bg-zinc-800 border-zinc-700' : 'bg-white border-gray-100'
              }`}>
                <button
                  type="button"
                  onClick={() => { setFilterPrintStatus("all"); setOpenPrintSelect(false); }}
                  className={`w-full text-left px-3 py-2 text-xs font-semibold ${filterPrintStatus === "all" ? "text-orange-500 bg-orange-50/50 font-bold" : isDark ? "text-zinc-300 hover:bg-zinc-700/60 hover:text-orange-400" : "text-gray-700 hover:bg-orange-50 hover:text-orange-500"}`}
                >
                ...
                <button
                  ...
                  className={`w-full text-left px-3 py-2 text-xs font-semibold ${filterPrintStatus === "printed" ? "text-orange-500 bg-orange-50/50 font-bold" : isDark ? "text-zinc-300 hover:bg-zinc-700/60 hover:text-orange-400" : "text-gray-700 hover:bg-orange-50 hover:text-orange-500"}`}
                >
                  🖨️ Printed Orders
                </button>
                <button
                  ...
                  className={`w-full text-left px-3 py-2 text-xs font-semibold ${filterPrintStatus === "unprinted" ? "text-orange-500 bg-orange-50/50 font-bold" : isDark ? "text-zinc-300 hover:bg-zinc-700/60 hover:text-orange-400" : "text-gray-700 hover:bg-orange-50 hover:text-orange-500"}`}
                >
                  🖨️ Unprinted Orders
                </button>
              </div>
        ...
        <div className="relative z-[45]">
          <button
            ...
            className={`flex items-center justify-between gap-1.5 px-3 py-2.5 border rounded-xl text-xs font-bold cursor-pointer min-w-[170px] text-left transition-colors ${
              isDark ? 'bg-zinc-800 border-zinc-700 text-zinc-200' : 'bg-gray-50 border-orange-500/10 text-gray-750'
            }`}
          >
            <span>
          ...
          {openSlotSelect && (
            <>
              ...
              <div className={`absolute left-0 right-0 top-full mt-1 border rounded-xl shadow-xl z-50 py-1 overflow-hidden animate-in fade-in slide-in-from-top-2 duration-150 max-h-48 overflow-y-auto min-w-[170px] ${
                isDark ? 'bg-zinc-800 border-zinc-700' : 'bg-white border-gray-100'
              }`}>
                <button
                  type="button"
                  onClick={() => { setFilterSlot("all"); setOpenSlotSelect(false); }}
                  className={`w-full text-left px-3 py-2 text-xs font-semibold ${filterSlot === "all" ? "text-orange-500 bg-orange-50/50 font-bold" : isDark ? "text-zinc-300 hover:bg-zinc-700/60 hover:text-orange-400" : "text-gray-700 hover:bg-orange-50 hover:text-orange-500"}`}
                >
                  All Delivery Slots
                </button>
                {deliverySlots.map((s) => (
                  <button
                    ...
                    className={`w-full text-left px-3 py-2 text-xs font-semibold ${filterSlot === String(s.id) ? "text-orange-500 bg-orange-50/50 font-bold" : isDark ? "text-zinc-300 hover:bg-zinc-700/60 hover:text-orange-400" : "text-gray-700 hover:bg-orange-50 hover:text-orange-500"}`}
                  >
                    {s.name}
                  </button>
                ))}
      ...
      <div className={`flex items-center gap-1 border-b px-2 overflow-x-auto whitespace-nowrap scrollbar-none py-1 select-none transition-colors ${
        isDark ? 'bg-zinc-900 border-zinc-800' : 'bg-white border-orange-500/20'
      }`}>
        {/* All Tab */}
        <button
          ...
          className={`flex items-center gap-1.5 px-4 py-2.5 text-xs font-bold transition-all relative border-b-2 cursor-pointer ${
            filterStatus === 'all'
              ...
              : isDark ? 'text-zinc-400 border-transparent hover:text-zinc-200' : 'text-gray-500 border-transparent hover:text-gray-800'
          }`}
        >
          <span>All</span>
          <span className={`text-[10px] font-bold px-1.5 py-0.5 rounded-full ${
            filterStatus === 'all' ? 'bg-orange-500/10 text-orange-600 font-black' : isDark ? 'bg-zinc-800 text-zinc-400' : 'bg-gray-100 text-gray-500'
          }`}>
            {counts['all']}
          </span>
        </button>
        ...
        {(['new', 'pending', 'processing', 'assigned', 'out_for_delivery', 'shipped', 'delivered', 'cancelled']).map((status) => {
          ...
          return (
            ...
            >
              ...
              <span>{label}</span>
              <span className={`text-[10px] font-bold px-1.5 py-0.5 rounded-full ${
                isActive ? 'bg-orange-500/10 text-orange-600 font-black' : isDark ? 'bg-zinc-800 text-zinc-400' : 'bg-gray-100 text-gray-500'
              }`}>
                {counts[status]}
              </span>
            </button>
          ...
          <table className="w-full text-left border-collapse min-w-[1250px]">
            <thead>
              <tr className={`border-b text-[10px] font-bold uppercase tracking-wider whitespace-nowrap transition-colors ${
                isDark ? 'bg-zinc-950/80 border-zinc-800 text-zinc-400' : 'bg-gray-50 border-orange-500/20 text-gray-400'
              }`}>
                <th className={`p-4 pl-5 sticky left-0 z-20 min-w-[210px] ${isDark ? 'bg-zinc-950' : 'bg-gray-50'}`}>Order</th>
                    ...
                    <React.Fragment key={order.id}>
                      <tr
                        className={`transition-colors cursor-pointer group whitespace-nowrap ${
                          isUnreviewed
                            ? isDark ? 'bg-amber-950/30 hover:bg-amber-900/40' : 'bg-[#fdf8ee] hover:bg-[#fbf1dc]'
                            : isDark ? 'bg-zinc-900 hover:bg-zinc-800/80' : 'bg-white hover:bg-[#fff9f3]'
                        }`}
                        onClick={() => {
                      ...
                      >
                        ...
                        <td
                          className={`p-4 sticky left-0 z-10 transition-colors ${
                            isUnreviewed
                              ? isDark ? 'bg-[#25190a] group-hover:bg-[#30210f] border-l-4 border-l-amber-500 pl-4' : 'bg-[#fdf8ee] group-hover:bg-[#fbf1dc] border-l-4 border-l-amber-500 pl-4'
                              : isDark ? 'bg-zinc-900 group-hover:bg-zinc-800/80 pl-5' : 'bg-white group-hover:bg-[#fff9f3] pl-5'
                          }`}
                        >
                        ...
                        <td className="p-4">
                          <div className="flex items-center gap-2">
                            ...
                            <div>
                              <span className={`text-xs font-bold block truncate max-w-[145px] ${isDark ? 'text-zinc-200' : 'text-gray-800'}`} title={order.customer_name || order.user?.email}>
                        ...
                        {/* Delivery Slot */}
                        <td className="p-4">
                          <span className={`text-xs font-semibold ${isDark ? 'text-zinc-300' : 'text-gray-650'}`}>
                        ...
                        {/* Total */}
                        <td className="p-4">
                          <span className={`text-xs font-black ${isDark ? 'text-zinc-100' : 'text-gray-900'}`}>
                        ...
                        {/* Age */}
                        <td className="p-4">
                          <span className={`text-xs font-semibold block ${isDark ? 'text-zinc-400' : 'text-gray-500'}`}>
                        ...
                        {/* Date */}
                        <td className="p-4">
                          <span className={`text-[10px] font-semibold ${isDark ? 'text-zinc-400' : 'text-gray-400'}`}>
                          ...
                          <div className="flex items-center justify-end gap-2">
                            ...
                            <div className="relative">
                              ...
                              {openPrintMenuId === order.id && (
                                <>
                                  ...
                                  />
                                  <div className={`absolute right-0 mt-1 border rounded-xl shadow-xl z-50 py-1.5 min-w-[170px] text-left animate-in fade-in slide-in-from-top-2 duration-150 ${
                                    isDark ? 'bg-zinc-800 border-zinc-700 text-zinc-200' : 'bg-white border-gray-150 text-gray-700'
                                  }`}>
                                    <div className={`px-3 py-1 text-[9px] font-black uppercase tracking-widest border-b mb-1 ${
                                      isDark ? 'text-zinc-400 border-zinc-700' : 'text-gray-400 border-gray-100'
                                    }`}>
                                      Select Print Format
                                    </div>
                                    <button
                                      ...
                                      className={`w-full text-left px-3 py-2 text-xs font-bold transition-colors flex items-center gap-1.5 cursor-pointer border-none bg-transparent ${
                                        isDark ? 'text-zinc-200 hover:bg-zinc-700/60 hover:text-orange-400' : 'text-gray-700 hover:bg-orange-55 hover:text-orange-600'
                                      }`}
                                    >
                                    ...
                                    <button
                                      ...
                                      className={`w-full text-left px-3 py-2 text-xs font-black text-orange-500 hover:bg-orange-55 transition-colors flex items-center gap-1.5 border-t mt-1 pt-2 cursor-pointer bg-transparent ${
                            ...
                            <button
                              ...
                              className={`p-1.5 rounded-lg transition-colors cursor-pointer border ${
                                isDark ? 'text-zinc-400 hover:text-zinc-200 hover:bg-zinc-800 border-zinc-700' : 'text-gray-400 hover:text-gray-700 hover:bg-gray-100 border-orange-500/20'
                              }`}
                            >
                      ...
                      {isExpanded && (
                        <tr className={isDark ? 'bg-zinc-950/80' : 'bg-orange-500/3'}>
                                ...
                                {(order.items || []).map((item) => (
                                  <div key={item.id} className={`flex items-center gap-3 border rounded-xl p-3 ${
                                    ...
                                    <div className="min-w-0 flex-1">
                                      <p className={`text-xs font-bold truncate ${isDark ? 'text-zinc-100' : 'text-gray-800'}`}>{item.product?.title || (item.sku ? `Product (${item.sku})` : `Product #${item.product_id}`)}</p>
                                      ...
                                      <p className={`text-[10px] ${isDark ? 'text-zinc-400' : 'text-gray-400'}`}>Qty: {item.quantity} × QAR {Number(String(item.price_at_purchase).replace(/([$]|qar|[\s,])/gi, "")).toFixed(2)}</p>
                                    </div>
                                    <span className={`text-xs font-black shrink-0 ${isDark ? 'text-zinc-100' : 'text-gray-800'}`}>
                                ...
                                <div className={`border rounded-xl p-4 space-y-3 ${
                                  ...
                                  <div className="flex items-start gap-2.5">
                                    ...
                                    <div className="flex-1 min-w-0">
                                      ...
                                      <p className={`text-xs font-bold mt-0.5 ${isDark ? 'text-zinc-200' : 'text-gray-800'}`}>{order.shipping_address}</p>
                                      <div className="flex items-center gap-2 mt-1.5 flex-wrap">
                                        {(order as any).latitude && (order as any).longitude ? (
                                          ...
                                          <span className={`inline-flex items-center gap-1 text-[9px] font-bold border px-2 py-0.5 rounded-full ${
                                            isDark ? 'bg-zinc-800 border-zinc-700 text-zinc-400' : 'bg-gray-100 border-gray-200 text-gray-500'
                                          }`}>
                                            ✏️ Manually Typed
                                          </span>
                                        )}
                                  ...
                                  <div className={`flex items-start gap-2.5 pt-2 border-t ${isDark ? 'border-zinc-800' : 'border-orange-500/10'}`}>
                                    <span className="text-xs mt-0.5 shrink-0">🕒</span>
                                    <div>
                                      <p className="text-[10px] text-gray-400 font-semibold uppercase">Delivery Slot</p>
                                      <p className={`text-xs font-bold mt-0.5 ${isDark ? 'text-zinc-200' : 'text-gray-800'}`}>
                                        {(order as any).deliverySlot?.name || deliverySlots.find(s => Number(s.id) === Number(order.delivery_slot_id))?.name || "None"}
                                      </p>
                                    </div>
                                  </div>
                                  <div className={`flex items-start gap-2.5 pt-2 border-t ${isDark ? 'border-zinc-800' : 'border-orange-500/10'}`}>
                                    ...
                                    <div>
                                      ...
                                      <p className={`text-xs font-bold mt-0.5 ${isDark ? 'text-zinc-200' : 'text-gray-800'}`}>{order.customer_email || order.user?.email || (order.user_id ? `User #${order.user_id}` : "—")}</p>
                                    </div>
                                  </div>
                                  <div className={`flex items-start gap-2.5 pt-2 border-t ${isDark ? 'border-zinc-800' : 'border-orange-500/10'}`}>
                                    ...
                                    <div>
                                      ...
                                      <p className={`text-sm font-black mt-0.5 ${isDark ? 'text-zinc-100' : 'text-gray-900'}`}>
                                        {order.total_price ? `QAR ${parseFloat(String(order.total_price).replace(/([$]|qar|[\s,])/gi, "") || "0").toFixed(2)}` : "—"}
                                      </p>
                                    </div>
                                  </div>
                                  {(order as any).delivery_payment_method && (
                                    <div className={`flex flex-col gap-3 pt-2 border-t ${isDark ? 'border-zinc-800' : 'border-orange-500/10'}`}>
                                      <div className="flex items-start gap-2.5">
                                        <span className="text-xs mt-0.5 shrink-0">💳</span>
                                        <div>
                                      ...
                                      {(order as any).delivery_payment_method === "Cash" && (
                                        <div className={`border rounded-xl p-3 space-y-2 mt-1 ${
                                          isDark ? 'bg-zinc-800/80 border-zinc-700' : 'bg-zinc-50 border-zinc-150'
                                        }`}>
                                          <div className="flex items-center justify-between">
                                            <span className={`text-[10px] font-bold uppercase ${isDark ? 'text-zinc-400' : 'text-gray-500'}`}>Cash Reconciliation</span>
                                  ...
                                  {/* Print Slip Section */}
                                  <div className={`pt-3 border-t flex flex-wrap items-center justify-between gap-2 ${isDark ? 'border-zinc-800' : 'border-orange-500/10'}`}>
                                    <div>
                                      <p className="text-[10px] text-gray-400 font-bold uppercase mb-1 flex items-center gap-1">
                                        <span>🖨️</span> Order Slip Tracking
                                      </p>
                                      <p className={`text-[10px] font-semibold ${isDark ? 'text-zinc-400' : 'text-gray-500'}`}>
