...
export const metadata: Metadata = {
  ...
  description: "Shop online in Qatar at GRIVA. Premium electronics, Apple & Samsung accessories, gaming gadgets, Arabic perfumes, buhoor, educational toys, baby products & kitchen essentials. Free same day delivery in Doha on orders over QAR 49. Cash on Delivery across all Qatar.",
  keywords: [
