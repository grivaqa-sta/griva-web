  ...
  return (
    <section className="w-full py-8">
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-6 px-4 sm:px-6 lg:grid-cols-[280px_1fr] lg:px-8">
        ...
        {/* Right Product Card */}
        <div className="relative min-h-[340px] overflow-hidden rounded-2xl border border-gray-100 bg-white p-6 shadow-sm">
            ...
            >
              ...
              <div className="flex shrink-0 items-start gap-3">
                ...
                <div className="flex shrink-0 flex-col gap-2">
                  {slide.thumbs.slice(0, 3).map((image, index) => (
                    <div
                      key={index}
                      className="flex h-12 w-12 shrink-0 items-center justify-center rounded-lg border bg-gray-50 p-1"
                    >
                      <Image
                        src={image}
                        alt="thumb"
                ...
                {/* Main Image */}
                <div className="relative flex h-[240px] w-[240px] shrink-0 items-center justify-center overflow-hidden rounded-xl bg-gray-50/50 p-4">
                  <Image
                    src={slide.mainImage}
                    alt={slide.title}
                    fill
              ...
              <div className="flex min-w-0 flex-1 flex-col justify-between">
                ...
                <button
                  ...
                  className="mt-6 flex h-10 w-44 cursor-pointer items-center justify-center gap-2 rounded-xl bg-orange-500 text-xs font-bold uppercase text-white shadow-md shadow-orange-500/10 transition hover:bg-orange-600"
                >
          ...
          <div className="absolute bottom-6 right-6 flex items-center gap-2">
            <button
              onClick={prev}
              className="flex h-8 w-8 cursor-pointer items-center justify-center rounded-full border border-gray-200 bg-white transition hover:border-orange-500 hover:text-orange-500"
            >
              <ChevronLeft size={16} />
            </button>
