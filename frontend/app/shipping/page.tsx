        ...
        <ScrollReveal>
          <div className="bg-white rounded-2xl border border-gray-100 p-6 md:p-8 shadow-sm space-y-6 text-sm text-gray-600 leading-relaxed">
            <section className="space-y-3">
              ...
              <p>
                We offer free delivery on all orders over QAR 49. For orders under QAR 49, a flat delivery fee of QAR 10 applies to any location within Qatar.
              </p>
                ...
                <table className="min-w-full divide-y divide-gray-200 border text-xs">
                  ...
                  <tbody className="divide-y divide-gray-100 bg-white">
                    <tr>
                      ...
                      <td className="px-4 py-3 text-green-600 font-semibold">Free (over QAR 49) / QAR 10</td>
                    </tr>
                    <tr>
