...
function OrderSuccessContent() {
  ...
  return (
    <div className="bg-gray-50/50 min-h-[85vh] flex flex-col items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-xl w-full bg-white p-8 sm:p-10 rounded-none shadow-md border border-gray-100 text-center">
        <div className="flex justify-center mb-6">
          <div className="h-20 w-20 rounded-none bg-green-50 border-2 border-green-200 flex items-center justify-center">
        ...
        <div className="max-w-md mx-auto mt-6 mb-8 bg-gray-50 border border-gray-150 p-6 rounded-none text-left space-y-4">
          {orderNumber && (
            <div className="flex justify-between items-center py-2 border-b border-gray-200 last:border-0">
              <span className="text-xs font-bold uppercase tracking-wider text-gray-505">Order Number</span>
              <span className="text-sm font-black text-orange-500 tracking-wide select-all">{orderNumber}</span>
            </div>
          )}
          {totalAmount && (
            <div className="flex justify-between items-center py-2 border-b border-gray-200 last:border-0">
              <span className="text-xs font-bold uppercase tracking-wider text-gray-550">Total Price</span>
              <span className="text-sm font-black text-gray-850 tracking-wide">{totalAmount}</span>
            </div>
          )}
          {slotName && (
            <div className="flex justify-between items-center py-2 border-b border-gray-200 last:border-0">
              <span className="text-xs font-bold uppercase tracking-wider text-gray-550">Delivery Slot</span>
              <span className="text-sm font-black text-gray-855 tracking-wide text-right">{slotName}</span>
            </div>
          )}
        </div>
        ...
        {!isAuthenticated && (
          <div className="bg-orange-50/50 rounded-none p-5 mb-8 border border-orange-100 text-left text-xs leading-relaxed text-orange-850 max-w-md mx-auto">
            <p className="font-bold mb-1 uppercase tracking-wide">💡 Guest checkout notes:</p>
            <p className="mb-2">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3.5 mt-8 max-w-md mx-auto">
          <Link
            ...
            className="w-full sm:w-auto flex-grow inline-flex items-center justify-center gap-2 rounded-none bg-orange-500 px-7 py-3.5 text-xs font-bold uppercase tracking-wide text-white hover:bg-orange-600 transition cursor-pointer"
          >
          ...
          <Link
            href="/shop"
            className="w-full sm:w-auto flex-grow inline-flex items-center justify-center gap-2 rounded-none bg-gray-100 border border-gray-200 px-7 py-3.5 text-xs font-bold uppercase tracking-wide text-gray-700 hover:bg-gray-200 transition cursor-pointer"
          >
